...
int Thermal::thermalContours(const cv::Mat &img, const double min,
...
void Thermal::contourCenters(const image_geometry::PinholeCameraModel model,
...
void Thermal::projectContour(const image_geometry::PinholeCameraModel model,
